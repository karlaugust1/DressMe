...
<body class="animsition">
					...
					<ul class="list-unstyled navbar__list">
						...
						<li class="active has-sub"><a class="js-arrow" href="#">
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a href="ListarOrcamentoServlet"> <i class="fas fa-pencil-square-o"></i>Or&ccedil;amento
								</a></li>
					...
					<nav class="navbar-sidebar2">
						<ul class="list-unstyled navbar__list">
							...
							<li class="active has-sub"><a class="js-arrow" href="#">
								...
								<ul class="list-unstyled navbar__sub-list js-sub-list">
									<li><a href="ListarOrcamentoServlet"> <i class="fas fa-pencil-square-o"></i>Orçamento
									</a></li>
									<li><a href="ListarPedidoVendaServlet"> <i
											class="fas fa-shopping-cart"></i>Pedido de Venda
									</a></li>
				...
				<div class="modal-body">
					<div class="table-responsive m-b-40">
						<c:choose>
							...
							<c:otherwise>
								<div class="alert alert-info">Nenhuma CondiÃ§Ã£o de
	...
	*
	<script type="text/javascript">
		//Script de ValidaÃ§Ã£o de Quantidade de Produto
		$(function() {
	...
	<script type="text/javascript">
	//Script de ValidaÃ§Ã£o de Desconto
	...
	<script type="text/javascript">
	//Script de ValidaÃ§Ã£o de Pedido
