 ...
 */
@WebServlet("/InserirClienteOrcamentoServlet")
public class InserirClienteOrcamentoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InserirClienteOrcamentoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PreOrcamentoServlet.pedidoVenda.setCliente(cliente);
