		...
		if (request.getParameter("inserir") != null) {
			...
			if (PrePedidoVendaServlet.vlrDesconto != 0) {
				...
				PrePedidoVendaServlet.pedidoVenda.getCliente()
						.setQtdPontos(PrePedidoVendaServlet.pedidoVenda.getNumeroPontos()+PrePedidoVendaServlet.pedidoVenda.getCliente().getQtdPontos());
				cs.updatePoints(PrePedidoVendaServlet.pedidoVenda.getCliente());
			}
			...
			EditarPedidoVendaServlet.pv.setValorTotal(EditarPedidoVendaServlet.pv.getValorSubtotal()
					- EditarPedidoVendaServlet.pv.getDesconto());
			if (EditarPedidoVendaServlet.vlrDesconto != 0) {
				...
				EditarPedidoVendaServlet.pv.getCliente()
						.setQtdPontos(EditarPedidoVendaServlet.pv.getNumeroPontos()+EditarPedidoVendaServlet.pv.getCliente().getQtdPontos());
				cs.updatePoints(EditarPedidoVendaServlet.pv.getCliente());
			}
