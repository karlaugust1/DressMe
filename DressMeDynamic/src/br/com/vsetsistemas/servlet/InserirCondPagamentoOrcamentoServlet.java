 ...
 */
@WebServlet("/InserirCondPagamentoOrcamentoServlet")
public class InserirCondPagamentoOrcamentoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InserirCondPagamentoOrcamentoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PreOrcamentoServlet.pedidoVenda.setCondPagamento(condPag);
