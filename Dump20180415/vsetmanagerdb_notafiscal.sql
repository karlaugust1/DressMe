...
CREATE TABLE `notafiscal` (
  ...
  `chave_de_acesso` bigint(20) NOT NULL,
  `data_emissao` datetime NOT NULL,
  `data_entrada_saida` datetime NOT NULL,
  `condpag` int(11) NOT NULL,
  `pedidovenda` bigint(20) NOT NULL,
  `empresa` bigint(20) NOT NULL,
  PRIMARY KEY (`numero`),
  KEY `condpag` (`condpag`),
  KEY `pedidovenda` (`pedidovenda`),
  KEY `empresa` (`empresa`),
  CONSTRAINT `notafiscal_ibfk_1` FOREIGN KEY (`condpag`) REFERENCES `condicao_pagamento` (`id`),
  CONSTRAINT `notafiscal_ibfk_2` FOREIGN KEY (`pedidovenda`) REFERENCES `pedidovenda` (`numero`),
  CONSTRAINT `notafiscal_ibfk_3` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`id`)
...
-- Dump completed on 2018-04-15 21:34:48
